...
class TAssignedScreen extends React.Component {
...
TAssignedScreen.propTypes = {
  id: PropTypes.number.isRequired
}
TAssignedScreen.defaultProps = {
  id: 0
}


export default connect(mapStateToProps, mapDispatchToProps)(TAssignedScreen);
