...
class TCompletedScreen extends React.Component {
...
TCompletedScreen.propTypes = {
  id: PropTypes.number.isRequired
}
TCompletedScreen.defaultProps = {
  id: 0
}


export default connect(mapStateToProps, mapDispatchToProps)(TCompletedScreen);
